          ...
          <div className="relative aspect-[16/10] overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 rounded-t-2xl">
            ...
            <div className="absolute top-3 right-3">
              <button
                type="button"
                aria-label="Options"
                className="w-8 h-8 bg-white/90 backdrop-blur-lg rounded-full flex items-center justify-center border border-blue-200/50 hover:bg-white hover:border-blue-300 transition-all duration-200 shadow-lg"
                onClick={(e) => {
                  e.stopPropagation();
                  setMenuOpen((m) => !m);
                }}
              ...
              {menuOpen && (
                <div
                  className="absolute right-0 mt-2 w-48 bg-white backdrop-blur-2xl text-gray-800 rounded-xl shadow-2xl border border-blue-200/50 z-50 overflow-hidden animate-fade-in-fast"
                ...
                >
                  <button
                    ...
                    className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-blue-50 transition font-medium text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-red-50 transition font-medium text-red-600 text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-blue-50 transition font-medium text-blue-600 text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
