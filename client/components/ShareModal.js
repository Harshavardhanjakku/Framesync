      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white border border-blue-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          />
        </div>
