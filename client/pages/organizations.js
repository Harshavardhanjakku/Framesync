  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-6">
        ...
        {organizations.length === 0 ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {organizations.map((org) => (
              <div
                key={org.id}
                className="bg-white/80 backdrop-blur-3xl rounded-2xl p-6 border border-blue-200/50 hover:border-blue-300/70 transition-all shadow-2xl hover:shadow-xl group"
              >
                {/* Organization Header */}
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <div className="flex items-center text-sm text-gray-700">
                    ...
                    <span className="font-medium text-gray-800">{org.member_count}</span>
                  </div>
                  {org.joined_at && (
                    <div className="flex items-center text-sm text-gray-700">
                      <span className="w-20 text-gray-500 font-medium">
      ...
      {showModal && selectedOrg && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-xl flex items-center justify-center p-4 z-50">
          <div className="bg-white backdrop-blur-3xl rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-blue-200/50 shadow-2xl">
            {/* Modal Header */}
            ...
            <div className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-800 border-b border-blue-200/50 pb-2">
              ...
              {/* Members List */}
              <div>
                <h3 className="text-lg font-semibold text-gray-800 border-b border-blue-200/50 pb-2 mb-4">
                  Members
                </h3>
                {loadingMembers ? (
                  ...
                  <div className="space-y-3 max-h-64 overflow-y-auto">
                    {orgMembers.map((member) => (
                      <div
                        key={member.id}
                        className="flex items-center justify-between p-4 bg-blue-50/50 backdrop-blur-3xl rounded-xl border border-blue-200/50 hover:bg-blue-100/50 transition-all"
                      >
            ...
            {/* Modal Footer */}
            <div className="flex justify-end space-x-3 p-6 border-t border-blue-200/50">
              <button
                onClick={closeModal}
                className="relative px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-bold transition-all group hover:bg-gray-200"
              >
                <span className="relative inline-block">
                  Close
                </span>
