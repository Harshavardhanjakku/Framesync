      ...
      <div className="pt-12 px-8 pb-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-8">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 backdrop-blur-md text-white rounded-2xl hover:from-blue-400 hover:to-blue-500 transition-all font-bold shadow-2xl hover:shadow-3xl flex items-center gap-3 group border border-blue-400 tracking-wide"
              >
                <svg
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2 p-1 bg-white/90 backdrop-blur-2xl rounded-2xl border border-blue-200/50 shadow-lg">
              {["all", "image", "video"].map((type) => (
                <button
                  key={type}
                  onClick={() => setFilterType(type)}
                  className={`relative px-6 py-2 rounded-xl font-semibold text-base transition-all duration-300 tracking-wider group ${
                    filterType === type
                      ? "text-blue-700 bg-blue-100 shadow-inner border border-blue-200"
                  ...
                  <span className="relative inline-block">
                    {type === "all"
                      ...
                      : type === "image"
                        ...
                        : "VIDEOS"}
                    <span
                      className={`absolute bottom-[-4px] left-1/2 w-0 h-[2px] bg-gradient-to-r from-blue-400 to-blue-600 transition-all duration-300 ease-out transform -translate-x-1/2 ${
                        filterType === type ? "w-full" : "group-hover:w-full"
                      }`}
                    ></span>
                  </span>
                </button>
          ...
          {filteredMedia.length === 0 ? (
            ...
            <>
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-gray-500 text-sm font-semibold tracking-wider">
                      ...
                      {uploadFile ? (
                        ...
                        <div className="text-gray-600">
                          <div className="text-5xl mb-4 text-blue-400">
                            <i
                              className="fa-solid fa-folder-open"
                              style={{ color: "#96C2DB", fontSize: "50px" }}
                            ></i>
                          </div>
                          ...
                          <p className="text-sm">
                            Images and videos supported (Max 50MB)
                          </p>
                        </div>
                      )}
                    </div>
